...
\newcommand{\spezialisierungsbereich}{Business Process Management}
\newcommand{\martikelnummer}{102247}
\newcommand{\dokumententyp}{Bachelorthesis}
\newcommand{\abgabedatum}{\today} 
\newcommand{\ort}{Paderborn} 
\newcommand{\koorperationsunternehmen}{Phoenix Contact GmbH & co. KG}
\newcommand{\fhdwstandort}{Paderborn} % oder Bielefeld, Mettmann, ...
\newcommand{\dokumententitel}{Personalisierung von Chatbots im Unternehmenskontext auf Basis konversationsbasierter Nutzerpräferenzen}
\newcommand{\dokumentenautor}{Fabio Mirabile}
\newcommand{\dokumentenautoradress}{Auf dem Anger 4\\33014 Bad Driburg}
\newcommand{\dokumentenpruefer}{Prof. Dr. Yvonne Gorniak}
...
\include{chapter/Weiterentwicklung}

\include{chapter/Testdurchführung}
