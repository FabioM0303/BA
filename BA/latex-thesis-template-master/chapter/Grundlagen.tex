...
Ein typischer Aufbau einer RAG Infrastruktur kann der Abbildung \ref{} entnommen werden. 
...
\begin{figure}[hbt]
	...
	\begin{minipage}[t]{1\textwidth} % Breite, z.B. 1\textwidth		
		\source{Quelle: \cite{Gao2023RetrievalAugmentedGF}}
		\caption{Retrieval Augmented Generation Prozess} % Überschrift
