\subsection{Identifikation des Problemraums}

Aus der zugrunde liegenden Problemstellung dieser Arbeit geht hervor, dass der betrachtete Chatbot bislang keine Funktionen zur Personalisierung von Nutzeranfragen bereitstellt. Die resultierende Einschränkung des Systems lässt sich im Kern auf zwei zentrale Defizite zurückführen:
...
Für die zielgerichtete Entwicklung eines geeigneten Artefakts ist ein vertieftes Verständnis des Problemraums unerlässlich. Neben der reinen Beschreibung der bestehenden Defizite ist es notwendig, die zugrunde liegenden Schwächen des aktuellen Systems sowie die relevanten Rahmenbedingungen systematisch zu analysieren. Aufbauend auf dieser Analyse erfolgt im weiteren Verlauf die Ableitung konkreter Zielsetzungen für das zu entwickelnde Artefakt.
