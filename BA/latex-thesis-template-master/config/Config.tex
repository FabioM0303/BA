...
\definecolor{cyan}{rgb}{0.0, 0.737, 0.89}
\definecolor{norange}{rgb}{1.0, 0.533, 0.0}
\definecolor{bgcolor}{rgb}{0.95, 0.95, 0.95}
\definecolor{dpink}{rgb}{0.5, 0.0, 0.5}


\lstdefinelanguage{ST}{
	morekeywords={IF, THEN, ELSE, ELSIF, END_IF, TRUE, FALSE, AND, NOT, OR, TYPE, END_TYPE, STRUCT, END_STRUCT, udt_FlowChief_OPCUA_Motor_04, Metadata_PLCnext, Monitoring_PLCnext, Commands_Scada, Parameterization_Scada },
	sensitive=false,
	morecomment=[l]{//},
	morestring=[b]",
}
...
\lstdefinelanguage{XML}{
	morekeywords={pv, aks, plant, signal, signal0, signal1, dataitemid, messagetemplate, condition, hmiObjectUrl},
	sensitive=false,
	morecomment=[l]{//},
	morestring=[b]",
}
...
\lstset{
	...
	escapeinside={(*@}{@*)},
	emph={TRUE},
	emphstyle=\color{dpink}\bfseries,
	emph={[2]FALSE},
	emphstyle={[2]\color{gray}\bfseries},
	emph={[3]:=},
...
\lstdefinestyle{xmlstyle}{
	...
	stringstyle=\color{norange},
	morecomment=[s][\color{gray}]{<!--}{-->},
	morekeywords=[2]{type, attributeName, itemidAppend, value},
	backgroundcolor=\color{bgcolor},
}
